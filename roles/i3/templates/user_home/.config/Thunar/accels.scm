...
(gtk_accel_path "<Actions>/ThunarWindow/switch-next-tab" "<Primary>bracketright")
...
(gtk_accel_path "<Actions>/ThunarWindow/close-window" "<Primary><Shift>q")
...
(gtk_accel_path "<Actions>/ThunarWindow/switch-previous-tab" "<Primary>bracketleft")
